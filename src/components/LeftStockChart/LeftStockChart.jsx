...
import './LeftStockChart.scss'
import axios from 'axios'

class LeftStockChart extends Component {
  state = {
    ticker: 'SPY',
    price: 0,
    series: [
  ...
  render() {
    return (
      <>
        <section className='leftChart'>
          <div className='leftChart-header'>
            <div className='leftChart-header-wrapper-1'>
              <h4 className='leftChart-header__stock'>{this.state.ticker}</h4>
              <p className='leftChart-header__price'>
                {this.state.price != 0 ? this.state.price : 'Loading'}
              </p>
            </div>
            <div className='leftChart-header-wrapper-2'>
              <form
                className='leftChart-header__search'
              ...
              >
                <input
                  ...
                  className='leftChart-header__input'
                  placeholder='Ticker'
                />
                <button type='submit' className='leftChart-header__button'>
                  Search
                </button>
              </form>
            </div>
          </div>
          <div className='leftChart__chart'>
